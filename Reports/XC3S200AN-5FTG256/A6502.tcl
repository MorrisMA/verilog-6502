# 
# Project automation script for A6502 
# 
# Created for ISE version 10.1
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source A6502.tcl, then you can
...
set myProject "A6502.ise"
set myScript "A6502.tcl"
...
proc set_project_props {} {
   ...
   project set family "Spartan2"
   project set device "xc2s200"
...
proc add_source_files {} {
   ...
   xfile add "../../../Git-Repo/verilog-6502/ALU.v"
   xfile add "../../../Git-Repo/verilog-6502/cpu.v"
   xfile add "cpu.ucf"
...
proc set_process_props {} {
   ...
   project set "SmartGuide Filename" "A6502_guide.ncd"
   ...
   project set "Multiplier Style" "LUT" -process "Synthesize - XST"
   ...
   project set "Global Clock Delay 0 (Binary String)" "11111" -process "Generate Programming File"
   project set "Global Clock Delay 1 (Binary String)" "11111" -process "Generate Programming File"
   project set "Global Clock Delay 2 (Binary String)" "11111" -process "Generate Programming File"
   project set "Global Clock Delay 3 (Binary String)" "11111" -process "Generate Programming File"
   ...
   project set "Configuration Rate" "4" -process "Generate Programming File"
   ...
   project set "Release Set/Reset (Output Events)" "Default (6)" -process "Generate Programming File"
   ...
   project set "Perform Timing-Driven Packing" "true" -process "Map"
   ...
   project set "Max Fanout" "100" -process "Synthesize - XST"
   ...
   project set "Convert Tristates To Logic" "Yes" -process "Synthesize - XST"
